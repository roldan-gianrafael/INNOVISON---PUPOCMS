                ...
                <a href="{{ route('assistant.enter-student') }}" class="chooser-link">
                    <article class="chooser-option">
                        ...
                        <div class="chooser-icon" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.59 14.37a6 6 0 1 0-11.18 0A17.93 17.93 0 0 0 12 21a17.93 17.93 0 0 0 7.59-6.63M15.59 14.37a6 6 0 1 1 0 0Z" />
                            </svg>
                        </div>
                        <div>
