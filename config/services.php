...
return [
    ...
    */
    ...
    'gemini' => [
        ...
        'fallback_models' => array_values(array_filter(array_map('trim', explode(',', env('GEMINI_FALLBACK_MODELS', 'gemini-2.5-flash,gemini-2.0-flash,gemini-2.0-flash-lite'))))),
    ],
    ...
    'puptas' => [
        ...
        'nonce_header' => env('PUPTAS_NONCE_HEADER', 'X-HMAC-Nonce'),
