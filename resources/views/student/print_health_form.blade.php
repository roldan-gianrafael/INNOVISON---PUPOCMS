...
<style>
    /* --- PRINT SETTINGS --- */
    @media print {
        /* 1. FORCE HIDE lahat ng admin components gamit ang display: none */
        .main-header, .main-sidebar, .main-footer, .content-header, 
        .breadcrumb, header, nav, aside, footer, .no-print, .btn, button,
        [class*="sidebar-"], .control-sidebar { 
        ...
        /* 2. I-RESET ang Admin Layout Wrapper - Ito ang sumisira sa alignment */
        .content-wrapper, .wrapper, .main-content, .container-fluid { 
        ...
        /* 3. Siguraduhin na ang Body at HTML ay walang gaps */
        html, body { 
            background: white !important; 
            margin: 0 !important; 
            padding: 0 !important;
            height: auto !important;
            visibility: hidden; /* Itatago lahat by default */
        }

        /* 4. IPAKITA LANG ANG FORM CONTAINER */
        .print-container { 
            ...
            left: 0 !important; 
            top: 0 !important; 
            width: 8.5in !important; /* Fixed width para sa papel */
            margin: 0 !important; 
            padding: 0.2in 0.5in !important; 
            box-shadow: none !important;
            border: none !important;
            background: white !important;
            z-index: 9999; /* Siguradong nasa ibabaw ng kahit anong admin element */
        }

        /* I-force na lahat ng nasa loob ng container ay lilitaw */
        .print-container * { 
            visibility: visible !important; 
        }
    ...
    /* --- SCREEN VIEW (Maintain your design) --- */
    ...
    .labels { white-space: nowrap; font-size: 13px; }
