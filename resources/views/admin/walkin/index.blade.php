...
<div class="card p-4">
    ...
    <form id="walkinForm" enctype="multipart/form-data" class="text-center mt-3">
        @csrf
        <input type="text" name="student_id" id="student_id" placeholder="Scan or enter Student ID" style="width:250px; padding:8px;" readonly>
        <input type="text" name="service" placeholder="Service" style="width:250px; padding:8px; margin-left:10px;">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (decodedText) => {
        ...
        const serviceField = form.querySelector('input[name="service"]');
        serviceField.focus();
